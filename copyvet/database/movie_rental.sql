...
--
CREATE DATABASE IF NOT EXISTS `movie_rental` DEFAULT CHARACTER
SET
...
--
INSERT INTO
  `director` (`id`, `fname`, `lname`, `bio`)
VALUES
  (
    1,
    'Joseph',
    'Kosinski',
    'Joseph Kosinski nació el 3 de mayo de 1974 en Iowa, Estados Unidos.'
  ),
  (
    2,
    'James',
    'Cameron',
    'James Cameron nació el 16 de agosto de 1954 en Ontario, Canadá.'
  ),
  (
    3,
    'Ryan',
    'Coogler',
    'Ryan Coogler nació el 23 de mayo de 1986 en Oakland, California, Estados Unidos.'
  ),
  (
    4,
    'Frank',
    'Darabont',
    'Frank Darabont nació el 28 de enero de 1959 en Francia.'
  ),
  (
    5,
    'James',
    'Gunn',
    'James Gunn nació el 5 de agosto de 1966 en St. Louis, Missouri, Estados Unidos.'
  );
...
--
INSERT INTO
  `inventory` (`movie_id`, `shop_id`, `price`)
VALUES
  (1, 1, 3000.00),
  (1, 2, 3000.00),
  (2, 1, 3500.00),
...
--
INSERT INTO
  `movie_cast` (`actor_id`, `movie_id`, `role`)
VALUES
  (1, 2, 'Jake Sully'),
  (2, 2, 'Neytiri Sully'),
  (2, 5, 'Gamora'),
...
--
INSERT INTO
  `movie_image` (`id`, `movie_id`, `image`, `created_at`)
VALUES
  (
    1,
    1,
    'movie-66db12b9cf65f.jpg',
    '2024-09-06 14:33:29'
  ),
  (
    2,
    2,
    'movie-66db13123b751.jpg',
    '2024-09-06 14:34:58'
  ),
  (
    3,
    4,
    'movie-66db27183be49.jpg',
    '2024-09-06 16:00:24'
  ),
  (
    4,
    5,
    'movie-66db27a040c85.jpg',
    '2024-09-06 16:02:40'
  ),
  (
    5,
    3,
    'movie-66db27cfac929.jpg',
    '2024-09-06 16:03:27'
  );
...
--
INSERT INTO
  `shop_rental` (`id`, `name`, `description`, `active`)
VALUES
  (
    1,
    'Alajuela',
    'Sucursal Alajuela, 100 m. este de la Catedral',
    1
  ),
  (
    2,
    'Heredia',
    'Sucursal Heredia, 200 m. sur de la UNA',
    1
  ),
  (
    3,
    'San José',
    'Sucursal San José, 150 m. este del parque de la Merce',
    1
  );
...
VALUES
  (
    ...
    'Administrador',
    'admin@prueba.com',
    '$2y$10$1ueeLDj8HL5ghcusBD/byOYhlcDBSiailMADfTkQ76dgU4IevRmNK',
    1,
    NULL,
    '2024-01-04 17:54:45',
    '2024-01-04 17:54:45'
...
--
ALTER TABLE `inventory` ADD PRIMARY KEY (`movie_id`, `shop_id`),
...
--
ALTER TABLE `movie_cast` ADD PRIMARY KEY (`actor_id`, `movie_id`),
...
--
ALTER TABLE `movie_image` ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `rental_movie` ADD PRIMARY KEY (`rental_id`, `movie_id`),
...
--
ALTER TABLE `shop_rental` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `actor` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 15;

--
-- AUTO_INCREMENT de la tabla `director`
--
ALTER TABLE `director` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 6;
...
--
ALTER TABLE `movie_image` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 6;

--
-- AUTO_INCREMENT de la tabla `rental`
--
ALTER TABLE `rental` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 6;
...
--
ALTER TABLE `shop_rental` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;
...
--
ALTER TABLE `inventory` ADD CONSTRAINT `inventory_movie` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `movie` ADD CONSTRAINT `fk_movie_director` FOREIGN KEY (`director_id`) REFERENCES `director` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `movie_cast`
--
ALTER TABLE `movie_cast` ADD CONSTRAINT `movie_cast_ibfk_1` FOREIGN KEY (`actor_id`) REFERENCES `actor` (`id`),
ADD CONSTRAINT `movie_cast_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`);

--
-- Filtros para la tabla `movie_genre`
--
ALTER TABLE `movie_genre` ADD CONSTRAINT `movie_genre_ibfk_1` FOREIGN KEY (`genre_id`) REFERENCES `genre` (`id`),
ADD CONSTRAINT `movie_genre_ibfk_2` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`);

--
-- Filtros para la tabla `movie_image`
--
ALTER TABLE `movie_image` ADD CONSTRAINT `movie_images_movie` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `rental`
--
ALTER TABLE `rental` ADD CONSTRAINT `rental_shop` FOREIGN KEY (`shop_id`) REFERENCES `shop_rental` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `rental_movie` ADD CONSTRAINT `rental_movie_movie` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
